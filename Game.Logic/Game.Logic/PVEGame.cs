...
namespace Game.Logic
{
    public class PVEGame : BaseGame
    {
        ...
        public PVEGame(int id, int roomId, PveInfo info, List<IGamePlayer> players, Map map, eRoomType roomType, eGameType gameType, int timeType, eHardLevel hardLevel, int currentFloor, long worldbossBood) : this(id, roomId, info, players, map, roomType, gameType, timeType, hardLevel, currentFloor)
        {
            WorldbossBood = worldbossBood;
        }
