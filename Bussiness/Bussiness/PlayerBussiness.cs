...
namespace Bussiness
{
	public class PlayerBussiness : BaseBussiness
	{
		...
		public bool AddChargeMoney(string chargeID, string userName, int money, string payWay, decimal needMoney, out int userID, ref int isResult, DateTime date, string IP, int UserID)
		{
			bool flag = false;
			userID = 0;
			try
