...
namespace Center.Service.actions
{
    public class ConsoleStart : IAction
    {
        ...
        {
            Console.Title = "CENTER | DDTANK 3.1 | 2026";
                    ...
                    switch (para[0].ToLower())
                    {
                        ...
                        case "worldboss":
                            ...
                            } else
                            {
                                ...
                                {
                                    case "open":
                                        CenterServer.Instance.WorldBossOpen(0, DateTime.Now, DateTime.Now.AddMinutes(50), DateTime.Now.AddMinutes(60));
                                        Console.WriteLine("World boss opened!");
                                        break;
                                    case "fightover":
                                        CenterServer.Instance.WorldBossFightOver();
                                        Console.WriteLine("World boss fight over!");
                                        break;
                                    case "close":
                                        CenterServer.Instance.WorldBossClose();
                                        Console.WriteLine("World boss closed!");
                                        break;
                                    default:
                                        Console.WriteLine("You need enter a valid parameter!");
                                        break;
